...
export declare class NoSQL implements Component {
    #private;
...
export { NoSQLByte, NoSQLByteSet, 
/**
 * Enums used in NoSQL
 */
NoSQLEnum, NoSQLItem, NoSQLMarshall, NoSQLNumberSet, NoSQLStringSet, NoSQLTable, NoSQLUnMarshall };
