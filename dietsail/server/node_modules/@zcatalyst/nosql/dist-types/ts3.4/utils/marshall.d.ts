...
export declare class NoSQLMarshall {
     ...
     */
    static makeSet(set: Set<string> | NoSQLStringSet | Set<number | bigint> | NoSQLNumberSet | Set<TNoSQLByte> | NoSQLByteSet, options?: Pick<MarshallOptions, Exclude<keyof MarshallOptions, 'convertClassInstanceToMap'>>): {
        [DataType.SS]: NoSQLStringSet;
    } | {
        [DataType.SB]: NoSQLByteSet;
    } | {
