...
import { ParsableComponent } from '@zcatalyst/utils';
import NoSQLResponse from './utils/response';
import { INoSQLDeleteItem, INoSQLFetchItem, INoSQLInsertItem, INoSQLQuery, INoSQLTable, INoSQLUpdateItem } from './utils/types';
export default class NoSQLTable implements ParsableComponent<INoSQLTable> {
    private "NoSQLTable.#private";
    constructor(requester: Handler, { tableDetails, tableId }: {
