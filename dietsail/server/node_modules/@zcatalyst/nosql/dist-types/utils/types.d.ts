...
export type TNoSQLValues = null | boolean | string | TNoSQLByte | number | bigint | Set<string> | NoSQLStringSet | Set<number | bigint> | NoSQLNumberSet | Set<TNoSQLByte> | NoSQLByteSet | NoSQLByte | Array<TNoSQLValues> | {
