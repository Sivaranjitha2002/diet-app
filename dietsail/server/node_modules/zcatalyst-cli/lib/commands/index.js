...
exports.default = (client) => {
    ...
    return Promise.all([
        ...
        loadCommand('token:revoke'),
        loadCommand('token:list'),
        loadCommand('project:list'),
        loadCommand('project:use'),
        ...
        loadCommand('ds:import'),
        loadCommand('ds:export'),
        loadCommand('ds:status'),
